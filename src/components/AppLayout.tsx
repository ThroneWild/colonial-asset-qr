    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
        ...
        <Button 
          ...
          className="h-8 w-8 rounded-full bg-background/50 backdrop-blur-sm border-border/50 hover:bg-destructive/10 hover:text-destructive hover:border-destructive/50"
          title="Sair"
        >
