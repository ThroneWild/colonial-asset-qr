import { Home, BarChart3, Package, ScrollText, Tag, LogOut, Wrench, Building2, Download, Calendar, Users } from "lucide-react";
...
export function AppSidebar() {
  ...
  const menuItems = [
    ...
    { label: "Calendário", href: "/maintenance/calendar", icon: <Calendar className="h-5 w-5" /> },
