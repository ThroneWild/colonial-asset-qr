...
export const SidebarBody = ({ className, children, ...props }: React.ComponentProps<typeof motion.div>) => {
  return (
    <>
      ...
      <MobileSidebar className={className as string | undefined}>
...
export const SidebarLink = ({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "flex items-center justify-start gap-2 group/sidebar py-2 cursor-pointer rounded-md px-2 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors",
