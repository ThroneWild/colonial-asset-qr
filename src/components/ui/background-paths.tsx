          ...
          >
            ...
            <div className="group relative inline-block overflow-hidden rounded-2xl bg-gradient-to-b from-black/10 to-white/10 p-px shadow-lg backdrop-blur-lg transition-shadow duration-300 hover:shadow-xl dark:from-white/10 dark:to-black/10">
              <Button
                ...
                className="rounded-[1.15rem] border border-black/10 px-8 py-6 text-lg font-semibold text-black transition-all duration-300 hover:shadow-md focus-visible:ring-0 group-hover:-translate-y-0.5 dark:border-white/10 dark:text-white dark:hover:shadow-neutral-800/50"
              >
